package io.github.contacts.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.github.contacts.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.github.contacts.repository.UserRepository.USERS_BY_EMAIL_CACHE);
