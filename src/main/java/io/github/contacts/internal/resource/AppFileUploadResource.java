package io.github.contacts.internal.resource;

import io.github.contacts.internal.model.FileNotification;
import io.github.contacts.internal.resource.decorator.IFileUploadResource;
import io.github.contacts.internal.service.HandlingService;
...
public class AppFileUploadResource implements IFileUploadResource {
    ...
    private final ContactsFileTypeService fileTypeService;
    ...
    public AppFileUploadResource(final IFileUploadResource fileUploadResourceDecorator, final HandlingService<FileNotification> fileNotificationHandlingService,
                                 final ContactsFileTypeService fileTypeService) {
    ...
    public ResponseEntity<ContactsFileUploadDTO> createFileUpload(@Valid @RequestBody ContactsFileUploadDTO fileUploadDTO) throws URISyntaxException {
        ...
        ResponseEntity<ContactsFileUploadDTO> responseEntity = fileUploadResource.createFileUpload(fileUploadDTO);

        ContactsFileType fileType = fileTypeService.findOne(fileUploadDTO.getContactsFileTypeId())
            .orElseThrow(() -> new NoSuchElementException("FileType of ID : " + fileUploadDTO.getContactsFileTypeId()+ " not found"));
        ...
        fileNotificationHandlingService.handle(FileNotification.builder()
                                                               ...
                                                               .contactsfileModelType(fileType.getContactsfileType())
