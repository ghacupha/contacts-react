...
public interface IFileUploadResource {
     ...
     */
    ResponseEntity<ContactsFileUploadDTO> createFileUpload(@Valid @RequestBody ContactsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ResponseEntity<ContactsFileUploadDTO> updateFileUpload(@Valid @RequestBody ContactsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     */
    ResponseEntity<List<ContactsFileUploadDTO>> getAllFileUploads(ContactsFileUploadCriteria criteria, Pageable pageable);
     ...
     */
    ResponseEntity<Long> countFileUploads(ContactsFileUploadCriteria criteria);
     ...
     */
    ResponseEntity<ContactsFileUploadDTO> getFileUpload(@PathVariable Long id);
