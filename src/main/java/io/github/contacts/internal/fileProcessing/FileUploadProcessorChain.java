...
public class FileUploadProcessorChain {
    ...
    private final List<FileUploadProcessor<ContactsFileUploadDTO>> fileUploadProcessors;

    public FileUploadProcessorChain(final List<FileUploadProcessor<ContactsFileUploadDTO>> fileUploadProcessors) {
    ...
    public void addProcessor(FileUploadProcessor<ContactsFileUploadDTO> fileUploadProcessor) {
        log.info("Adding new file-upload processor {}", fileUploadProcessor);
        this.fileUploadProcessors.add(fileUploadProcessor);
    }

    public List<ContactsFileUploadDTO> apply(ContactsFileUploadDTO fileUploadDTO, FileNotification fileNotification) {
