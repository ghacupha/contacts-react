 ...
 */
public class BatchSupportedFileUploadProcessor implements FileUploadProcessor<ContactsFileUploadDTO>  {
    ...
    private final ContactsFileModelType fileModelType;

    public BatchSupportedFileUploadProcessor(final JobLauncher jobLauncher, final Job batchJob, final ContactsFileModelType fileModelType) {
    ...
    @Override
    public ContactsFileUploadDTO processFileUpload(final ContactsFileUploadDTO fileUpload, final FileNotification fileNotification) {

        if (fileNotification.getcontactsfileModelType() == fileModelType) {
