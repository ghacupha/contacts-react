...
/**
 * A DTO for the {@link io.github.contacts.domain.ContactsFileUpload} entity.
 */
public class ContactsFileUploadDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContactsFileUploadDTO)) {
            return false;
        }

        return id != null && id.equals(((ContactsFileUploadDTO) o).id);
    }
