...
/**
 * A DTO for the {@link io.github.contacts.domain.ContactsMessageToken} entity.
 */
public class ContactsMessageTokenDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContactsMessageTokenDTO)) {
            return false;
        }

        return id != null && id.equals(((ContactsMessageTokenDTO) o).id);
    }
    ...
    public String toString() {
        return "ContactsMessageTokenDTO{" +
            "id=" + getId() +
